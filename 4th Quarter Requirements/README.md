...
## Contributors
- Student 1: Chelene Danielle B. Harden (code maker, maker for questions and answers of DC and Valorant, researcher)
- Student 2: Emmy Rosette P. Plazuela (maker for questions and answers of F1 and Valorant, testing of code, researcher to improve the code)

## Progress:
- We have full complete code at this point. For fourth quarter, we will improve it and make it more appealing.
